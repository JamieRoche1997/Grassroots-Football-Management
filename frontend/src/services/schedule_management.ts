 ...
 */
export const fetchFixturesByMonth = async (
  month: string,
  clubName: string,
  ageGroup: string,
  division: string
  ...
  try {
    ...
    const response = await fetch(
      `${url}/schedule/fixture?month=${encodeURIComponent(
        month
...
export const getFixtureById = async (
  ...
  try {
    const headers = await getAuthHeaders();
    const response = await fetch(
      `${url}/schedule/fixture/${matchId}?clubName=${encodeURIComponent(
        clubName
...
export const fetchAllFixtures = async (
  ...
  try {
    const headers = await getAuthHeaders();
    const response = await fetch(
      `${url}/schedule/fixtures?clubName=${encodeURIComponent(
        clubName
      )}&ageGroup=${encodeURIComponent(ageGroup)}&division=${encodeURIComponent(
        division
      )}`,
...
export const deleteFixture = async (
  ...
  try {
    const headers = await getAuthHeaders();
    const response = await fetch(
      `${url}/schedule/fixture?matchId=${encodeURIComponent(
        matchId
      )}&clubName=${encodeURIComponent(clubName)}&ageGroup=${encodeURIComponent(
        ageGroup
      )}&division=${encodeURIComponent(division)}`,
 ...
 */
export const fetchTrainingsByMonth = async (
  month: string,
  clubName: string,
  ageGroup: string,
  division: string
  ...
  try {
    const headers = await getAuthHeaders();
    const response = await fetch(
      `${url}/schedule/training?month=${encodeURIComponent(
        month
      )}&clubName=${encodeURIComponent(clubName)}&ageGroup=${encodeURIComponent(
        ageGroup
      )}&division=${encodeURIComponent(division)}`,
...
export const getTrainingById = async (
  ...
  try {
    const headers = await getAuthHeaders();
    const response = await fetch(
      `${url}/schedule/training/${trainingId}?clubName=${encodeURIComponent(
        clubName
      )}&ageGroup=${encodeURIComponent(ageGroup)}&division=${encodeURIComponent(
        division
      )}`,
 ...
 */
export const fetchAllTrainings = async (
  clubName: string,
  ageGroup: string,
  division: string
): Promise<TrainingData[]> => {
  try {
    const headers = await getAuthHeaders();
    const response = await fetch(
      `${url}/schedule/trainings?clubName=${encodeURIComponent(
        clubName
      )}&ageGroup=${encodeURIComponent(ageGroup)}&division=${encodeURIComponent(
        division
      )}`,
...
export const deleteTraining = async (
  ...
  try {
    const headers = await getAuthHeaders();
    const response = await fetch(
      `${url}/schedule/training?trainingId=${encodeURIComponent(
        trainingId
      )}&clubName=${encodeURIComponent(clubName)}&ageGroup=${encodeURIComponent(
        ageGroup
      )}&division=${encodeURIComponent(division)}`,
...
export const fetchFixtureAvailability = async (
  ...
  const res = await fetch(
    `${url}/schedule/fixture/availability?${queryParams}`,
    {
      method: "GET",
      headers,
    }
...
export const fetchTrainingAvailability = async (
  ...
  const res = await fetch(
    `${url}/schedule/training/availability?${queryParams}`,
    {
      method: "GET",
      headers,
    }
