...
import { Box, Typography, CircularProgress, Alert, FormControl, Select, MenuItem } from "@mui/material";
...
export default function Transactions() {
    ...
    const filteredTransactions = transactions.filter((tx) => {
        ...
        const matchesDate =
            ...
            (!endDate || new Date(tx.timestamp) <= new Date(new Date(endDate).setHours(23, 59, 59, 999)));
    ...
    return (
        <Layout>
            ...
            <Box sx={{ p: 4 }}>
                ...
                {!loading && filteredTransactions.length === 0 && <Alert severity="info">No transactions found.</Alert>}

                {!loading && filteredTransactions.length > 0 && <TransactionTable transactions={filteredTransactions} />}
            </Box>
