...
import { SportsSoccer, EmojiEvents, LocalActivity, Warning, Dangerous } from "@mui/icons-material";
                ...
                {loading ? (
                    ...
                    <>
                        ...
                        <Grid container spacing={3}>
                                ...
                                <StatCard>
                                    <CardContent sx={{ p: 0 }}>
                                        ...
                                        <StatItem>
                                            ...
                                            <StatValue variant="h6" sx={{ color: theme.palette.warning.main }}>
                                        ...
                                        <StatItem>
                                            ...
                                            <StatValue variant="h6" sx={{ color: theme.palette.error.main }}>
                            ...
                            {/* Additional Stats Section - Removed per-match calculations */}
                            <Grid size={{ xs: 12 }}>
                                <StatCard>
                                    <CardContent>
                                        ...
                                        <Box sx={{
                                            ...
                                            <StatCard variant="outlined" sx={{ p: 2 }}>
                                                ...
                                                <StatValue variant="h5" sx={{ color: theme.palette.warning.main }}>
