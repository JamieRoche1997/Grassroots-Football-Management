  ...
  return (
    <Layout>
      ...
      <Box sx={{ 
        ...
        {selectedMatch && (
          <>
            <Typography variant="h6" sx={{ mb: 3, fontWeight: 600 }}>
              ...
              {drivers.filter(d => d.matchId === selectedMatch).length} Driver(s) Available
            </Typography>
            ...
            <Grid container spacing={3}>
              {drivers
                ...
                .map(driver => {
                  ...
                  const matchDetails = matches.find(m => m.matchId === driver.matchId);
                  const opponentTeam = matchDetails?.homeTeam === clubName 
                        ...
                        <CardContent>
                          ...
                          <Box sx={{ display: 'flex', flexDirection: 'column', gap: 1.5 }}>
                            ...
                            <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5 }}>
                              ...
                              <Typography variant="body2">
                                <strong>{driver.seats} seat{driver.seats !== 1 ? 's' : ''} available</strong>
                              </Typography>
                            </Box>
                            ...
                            <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5 }}>
                              ...
                              <Typography variant="body2">
                                Pickup stops: <strong>{driver.pickup === "Yes" ? 'Available' : 'Not available'}</strong>
                              </Typography>
                            </Box>
                          </Box>
        ...
        {/* Empty State */}
        {selectedMatch && drivers.filter(d => d.matchId === selectedMatch).length === 0 && (
          <Box sx={{ 
            textAlign: 'center', 
            py: 6,
        ...
        >
          ...
          <DialogContent sx={{ p: 3 }}>
            <Typography>
              Are you sure you want to cancel your ride for <strong>{selectedDriver?.matchDetails}</strong>?
            </Typography>
