...
import { Card, CardContent, Typography, Grid2 as Grid, Skeleton, Stack } from '@mui/material';
      ...
      try {
        ...
        setEvents([
          { 
            ...
            description: previousMatch ? `${previousMatch.homeTeam} vs ${previousMatch.awayTeam}` : 'No match found', 
            date: previousMatch?.date || '-',
            type: 'match'
          },
          { 
            title: 'Upcoming Match', 
            description: upcomingMatch ? `${upcomingMatch.homeTeam} vs ${upcomingMatch.awayTeam}` : 'No match found', 
