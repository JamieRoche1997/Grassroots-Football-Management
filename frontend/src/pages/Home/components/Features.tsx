...
const featuresData = [
  ...
  },
  {
    img: Carpool,
    tag: "Carpooling",
    title: "Organise carpools for team transportation",
    description:
  ...
  },
  {
    ...
    description:
      "Utilise our AI chatbot for answering questions, providing insights, and streamlining team communication.",
  },
];
...
export default function Features() {
  ...
  return (
    ...
    >
      ...
      >
        <Chip
          onClick={() => handleFilter("All features")}
          size="medium"
          label="All features"
        />
        <Chip
        ...
        />
        <Chip
          onClick={() => handleFilter("Carpooling")}
          size="medium"
          label="Carpooling"
        />
        <Chip
          onClick={() => handleFilter("Payment Collection")}
          size="medium"
        ...
        />
        <Chip
          onClick={() => handleFilter("Performance Tracking")}
          size="medium"
          label="Performance Tracking"
        />
        <Chip
          onClick={() => handleFilter("AI Chatbot")}
          size="medium"
          label="AI Chatbot"
        />
      </Box>
